...
const Generate_qrcode = ({ navigation, route }) => {
        ...
        return (
            <>
                ...
                <View style={style.header}>
                    <Text style={style.header_text}>أخذ الغياب</Text>
                </View>
            </>
        )
    }
                                    ...
                                    <View style={style.Qrcode_generate}>
                                        {show_qr == true ?
                                            <QRCode
                                                ...
                                                size={300}
                                            />
                                            : <Text style={style.Qr_text}> لا يوجد QR</Text>
                                        }
                                    </View>

                                    {show_qr == true ?
                                        <View style={style.View_Qr_code_num}>
                                            <Text style={style.Text_Qr_code_num}>{lectures_data}</Text>
                                        </View> :
                                        null
